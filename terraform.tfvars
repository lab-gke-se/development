networks = {
  ...
  dev-network = {
    ...
    subnetworks = {
      ...
      tenant-gke-standard-0 = {
        ip_cidr_range            = "100.88.5.0/25"
        region                   = "us-east4"
        private_ip_google_access = true
        secondary_ip_ranges = {
      ...
      tenant-gke-standard-1 = {
        ip_cidr_range            = "100.88.6.0/25"
        region                   = "us-east4"
        private_ip_google_access = true
        secondary_ip_ranges = {
          tenant-gke-services = "240.6.36.0/22"
          tenant-gke-pods     = "240.6.64.0/19"
        }
      }
      proxy = {
